...
var site = "/" + pathArray[1] + "/tms_online/resource/js/";
var webcam_files = pathArray[0] + "/tms_online/resource/js/";
...
window.webcam = {
  ...
  swf_url: webcam_files+'webcam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
  shutter_url: webcam_files+'webcam/shutter.mp3', // URI to shutter.mp3 sound
  api_url: webcam_files+'webcam/test.php', // URL to upload script
