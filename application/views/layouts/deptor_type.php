    ...
    function edit_debtor_type(id)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="debtortype_receivable_acc"]').val(data.receiveable_coa_rowID);
            $('[name="debtortype_advance_acc"]').val(data.advance_coa_rowID);
            $('[name="debtortype_deposit_acc"]').val(data.deposit_coa_rowID);
            $('[name="debtortype_rounding_acc"]').val(data.rounding_coa_rowID);
            $('#modal_form').modal('show');
...
function save_deptor_type(){
      ...
      {
          url = "<?php echo base_url('debtor_type/edit')?>";
      }
                          ...
                          html: false
                            ...
                            if (r){
                                  $.ajax({
                                    url : url,
                                    type: "POST",
                                    data: $('#form_deptor_type').serialize(),
                                    dataType: "JSON",
                                    success: function(data)
                                    {
                                            $('#modal_form').modal('hide');
