      ...
      <section class="vbox">
        <header class="header bg-white b-b clearfix">
          <div class="row m-t-sm">
            ...
            <a class="btn btn-sm green" href="<?=base_url()?>projects/view_projects/all" title="<?=lang('projects')?>" data-original-title="<?=lang('projects')?>" data-toggle="tooltip" data-placement="bottom">
