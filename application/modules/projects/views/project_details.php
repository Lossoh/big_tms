<section id="content">
	<section class="vbox">
		...
		<header class="header bg-white b-b b-light">
			...
			<?php
			if ($project->timer == 'On') { ?>
			<a href="<?=base_url()?>projects/tracking/off/<?=$project->project_id?>" class="btn btn-sm red "> <i class="fa fa-clock-o text-white"></i> <?=lang('stop_timer')?></a>
			<?php }else{ ?>
			...
			<a href="<?=base_url()?>projects/pilot/on/<?=$project->project_id*8600?>" data-original-title="<?=lang('auto_progress_on')?>" class="btn btn-sm green" data-toggle="tooltip" data-placement="left"> <i class="fa fa-rocket text-white"></i></a>
			<?php }else{ ?>
			<a href="<?=base_url()?>projects/pilot/off/<?=$project->project_id*8600?>"  data-original-title="<?=lang('auto_progress_off')?>" class="btn btn-sm green" data-toggle="tooltip" data-placement="left"> <i class="fa fa-power-off text-white"></i></a>
			<?php } ?>
		</header>
