			...
			<?php
				...
				<header class="header bg-white b-b clearfix">
					<div class="row m-t-sm">
						...
						<a class="btn btn-sm red" href="<?=base_url()?>projects/delete/<?=$project->project_id?>" title="<?=lang('delete_project')?>" data-toggle="ajaxModal" data-placement="bottom">
...
<?php
          ...
          <?php echo validation_errors('<span style="color:red">', '</span><br>'); ?>
			 <input type="hidden" name="project_id" value="<?=$project->project_id?>">
				...
				<select name="assign_to[]" multiple="multiple" class="form-control" required>
				...
				<button type="submit" class="btn btn-sm green"><i class="fa fa-check"></i> <?=lang('save_changes')?></button>
