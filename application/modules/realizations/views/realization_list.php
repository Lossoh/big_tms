...
$(function() {
    ...
    var table_realization = $('#tbl-realization').DataTable({
        ...
        ajax: {
            url: "<?= base_url() ?>realizations/fetch_data",
            type: 'POST',
...
<aside class="aside-xxl bg-white b-l hide" id="aside">
    <section class="vbox">
		<section class="scrollable wrapper">
            <?=form_open(base_url().'realizations/set_filter','autocomplete="off" id="form_period" class="form-horizontal"')?>                    
            <div class="row">
                <div class="col-md-9">
