						...
						<div class="group">	
							<div class="row inline-fields form-group form-md-line-input">
								...
								<div class="col-md-8"><p>										
									<input class="input-sm input-s form-control tanggal_datetimepicker" size="10" type="text" value="<?=date('d-m-Y')?>" id="date" name="date" required>
								</p></div>
							</div>	
							<div class="row inline-fields form-group form-md-line-input">
								...
								<div class="col-md-8"><p>
									<input  type="text" class="paid_amount form-control currency" id="paid_amount" name="paid_amount" maxlength="9" style="font-size:22px;font-weight:900;color: black;text-align: right;" value="0" autocomplete="off" onblur="calculation_refund_ca()" readonly="" required>
								</p></div>
							...
							<div class="row inline-fields form-group form-md-line-input">
								...
								<div class="col-md-8">
								   <textarea class="form-control" id="refund_desc" name="refund_desc" maxlength="255" rows="2" readonly=""></textarea>
                                </div>
							</div>			
