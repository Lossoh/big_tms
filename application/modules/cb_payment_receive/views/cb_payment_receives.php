...
<section class="vbox">
    <header class="header bg-white b-b b-light">
        ...
        <p class="pull-left"><?=lang('cb_payment_receive')?> Reports</p>
    </header>
        ...
        <div class="col-lg-12">
          <div class="panel panel-primary">
            <div class="panel-body">
                <?=form_open(base_url('cb_payment_receive/print_report'),'autocomplete="off" id="form" name="form" class="form-horizontal" target="_blank"')?>
                <div class="form-group form-md-line-input row">
                    ...
                    <div class="col-md-3">
                        <div class="input-group input-daterange">
                            <?php
                            $filter_start_date = date('d-m-Y');
                            $filter_end_date = date('d-m-Y');
                            ?>
                            <input type="text" name="start_date" id="start_date" class="form-control input-sm" placeholder="<?=lang('start_date')?>" value="<?=date('d-m-Y', strtotime($filter_start_date))?>">
                            <span class="input-group-addon">to</span>
                            <input type="text" name="end_date" id="end_date" class="form-control input-sm" placeholder="<?=lang('end_date')?>" value="<?=date('d-m-Y', strtotime($filter_end_date))?>">
                        </div>                    
                    </div>
                </div>
                <div class="form-group form-md-line-input row">
