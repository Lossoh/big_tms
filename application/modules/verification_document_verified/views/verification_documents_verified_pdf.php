...
<title><?php echo lang('verification_documents_verified'); ?></title>
</head>
...
<div id="header">
    <h2><?php echo lang('verification_documents_verified'); ?></h2>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="0">
    ...
    $no=1;
    $total_realization = 0;
    if(!empty($verification_documents_verified)){	
        foreach($verification_documents_verified as $doc){
            $document = '';
