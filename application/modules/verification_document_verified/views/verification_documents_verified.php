        ...
        <header class="header bg-white b-b b-light">
            <div class="row" style="padding-top: 10px;">
                <div class="col-md-6" style="padding-top: 5px;">
                    <p><?=lang('verification_documents_verified')?></p>              
                </div>     
                <div class="col-md-6 text-right">
                   <!--  <a href="#aside" data-toggle="class:show" id="btnFilter" onclick="showFilterText()" style="color: #46b8da;">Show Filter</a> &nbsp; -->
                    ...
                    ?>
                        <button type="button" class="btn btn-sm red" onclick="verification_document_verified_pdf()"><i class="fa fa-file-pdf-o"></i> Print PDF</button>
                    <?php
                    }
                    ?>
                </div>
...
$(function() {
   ...
   var table_verification = $('#tbl-data-verification').DataTable({
        ...
        ajax: {
            url: "<?= base_url() ?>verification_document_verified/fetch_data",
            type: 'POST',
...
<aside class="aside-xxl bg-white b-l hide" id="aside">
    <section class="vbox">
		<section class="scrollable wrapper">
            <?=form_open(base_url().'verification_document_verified/set_filter','autocomplete="off" id="form_period" class="form-horizontal"')?>                    
            <div class="row">
                <div class="col-md-9">
