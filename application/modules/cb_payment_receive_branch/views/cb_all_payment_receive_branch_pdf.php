...
<title>Report All Cash Bank and Payment (Branch)</title>
</head>
    ...
    ?>
            <table width="100%">
                <tr>
                    <td width="50%" align="left">
                        <?php
                        $get_data_coa = $this->cb_payment_receive_branch_model->get_data_by_row_id('gl_coa',$row_coa->rowID);
                        ?>
            ...
            <table width="100%" cellpadding="1" cellspacing="0">
            	<tr>    
            		...
            		<th width="17%" rowspan="2" style="border-top: #000000 double 5px;border-bottom: #000000 solid 1px;">Payment To / Receive From</th>
                ...
                $data_cb_trx = $this->cb_payment_receive_branch_model->get_data_cb_trx_hdr_by_date($row_coa->rowID,$start_date,$end_date,$start_time,$end_time);
                $data_cb_trx2 = $this->cb_payment_receive_branch_model->get_data_cb_trx_hdr_by_date2($row_coa->rowID,$start_date,$end_date,$start_time,$end_time);
                           ...
                           */
                           ...
                           //if($coa_rowID == $row_coa->rowID){           
                               ...
                               if($row->debtor_creditor_type == 'D'){
                                    $get_data_deb_cre = $this->cb_payment_receive_branch_model->get_data_by_row_id('sa_debtor',$row->debtor_creditor_rowID);
                                    $payment_to = $get_data_deb_cre->debtor_name;
                               }
                               elseif($row->debtor_creditor_type == 'C'){
                                    $get_data_deb_cre = $this->cb_payment_receive_branch_model->get_data_by_row_id('sa_creditor',$row->debtor_creditor_rowID);
                ...
                ?>
                    ...
                    <tr>
                        <td colspan="5" align="right" style="border-top: #ffffff solid 1px;border-left: #000000 solid 1px;"> &nbsp; </td>
