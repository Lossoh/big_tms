<section id="content">
          <section class="hbox stretch">
            ...
            <aside>
              <section class="vbox">
               <header class="header bg-white b-b b-light">
                  <a href="#aside" data-toggle="class:show" class="btn btn-sm green pull-right"><i class="fa fa-plus"></i> <?=lang('new_truck')?></a>
                  <p><?=lang('registered_truck')?></p>
                </header>
			...
			foreach ($users as $key => $user) { ?>
					...
					<a href="<?=base_url()?>users/account/delete/<?=$user->user_id?>" class="btn red btn-xs" data-toggle="ajaxModal" title="<?=lang('delete')?>"><i class="fa fa-trash-o"></i></a>
					<?php } ?>
					</td>
									</tr>
									<?php } } ?>
