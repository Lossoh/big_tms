...
<div class="modal-dialog" id="add_modal">
	<div class="modal-content">
		...
		<div class="modal-header"> <button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title"><?=lang('delete_truck')?></h4>
		</div>
					
		<?php 

		$attributes = array('class' => 'bs-example form-horizontal');
        echo form_open(base_url().'trucks/delete_truck',$attributes); ?>          
		...
		<div class="modal-body">
			...
			<div class="form-group form-md-line-input">
				<label class="col-lg-4 control-label"><?=lang('gps_id')?> </label>
					<div class="col-lg-8">
						<input type="text" class="form-control" value="<?=$truck_detail->gps_id?>" readonly>
					</div>
			</div>			
			<div class="form-group form-md-line-input">
			<label class="col-lg-4 control-label"><?=lang('truck_type')?> <span class="text-danger">*</span></label>
				<div class="col-lg-8">
					<select id="select2-option" style="width:260px" name="truck_type_id" disabled> 
		...
		<button type="submit" class="btn green"><?=lang('delete_truck')?></button>
		</form>
<?php }}?>
		</div>
	</div>
