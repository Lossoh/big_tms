		...
		<aside>
			<section class="vbox">
				<header class="header bg-white b-b b-light">
					...
					<p class="pull-left"><strong><?=lang('update_option')?> <?=lang('job_order')?></strong></p>
				</header>
						...
						<div class="group">
							...
							<div class="row inline-fields form-group form-md-line-input">
 							...
 							<div class="row inline-fields form-group form-md-line-input">
								...
								<div class="col-md-1">:</div>
								<div class="col-md-5"><p class="h3">
									<input  type="text" class="form-control" id="job_order_price" name="job_order_price" onkeyup="angka(this)" maxlength="9" value="<?=$job_order['price_amount']?>" style="text-align: right;" autocomplete="off">
								</p></div>
								<div class="col-md-1"><p class="h3">Kgs</p></div>			
							</div>
							<div class="row inline-fields form-group form-md-line-input">
