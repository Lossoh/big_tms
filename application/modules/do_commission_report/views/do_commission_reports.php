...
<section class="vbox">
    <header class="header bg-white b-b b-light">
        ...
        <p class="pull-left"><?=lang('do_commission_report')?> Report</p>
    </header>
        ...
        <div class="col-lg-12">
          <div class="panel panel-primary">
            <div class="panel-body">
                <?=form_open(base_url('do_commission_report/print_report'),'autocomplete="off" id="form" name="form" class="form-horizontal" target="_blank"')?>
                ...
                <div class="form-group form-md-line-input row">
                    <label class="col-md-3 control-label">Driver <span class="text-danger">*</span></label>
                    <div class="col-md-3">
                        <select class="form-control all_select2" name="debtor_id" id="debtor_id" >
                            <option value="all">- All -</option>
                            <?php
                            foreach($drivers as $row){
                                echo '<option value="'.$row->rowID.'">'.$row->debtor_name.'</option>';
                            }
                            ?>
                        </select>
                    </div>
