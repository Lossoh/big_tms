    ...
    <tr valign="top">
          ...
          <table width="100%">
              ...
              ?> 
                  ...
                  <tr>
                    <td>Kargo</td>
    				<td>:</td>
    				<td><?=$all_data->item_name != '' ? $all_data->item_name : '-'?></td>
                  </tr> 
                  <tr>
                  ...
                  <tr>
                    <td>No Kontainer</td>
    				<td>:</td>
    				<td><?=$all_data->spk_container_no != '' ? $all_data->spk_container_no : '-'?></td>
                  </tr>  
              <?php
              }
              ?>
              ...
              <tr>
                <td colspan="3" align="left" style="font-size: 11px;">
                    1) Asli untuk Kantor Pusat. <br />
                    2) <i>Copy</i> untuk Petugas Uang Jalan. <br />                        
      ...
      ?>
          ...
          <table class="table table-responsive table-striped table-condensed table-hover" width="100%">
              ...
              <tr>
                <td><?=lang('dari_ke')?><span style="font-size: 13px;">*</span></td>
				<td>:</td>
				<td>
                    <?php
                    $destination = '-';
              ...
              <tr>
                <td colspan="3" align="left" style="font-size: 11px;">
                    1) Asli untuk Petugas Surat Muat. <br /> 
                    2) <i>Copy</i> untuk Supir. <br />
                    3) Periksa kembali dokumen yang dibawa seperti KIR, STNK &amp; Kunci Mobil. <br />
                    <i>*) Tujuan pengiriman dapat disesuaikan dengan kegiatan di lapangan.</i> <br />
                    <?=lang('dicetak_oleh').' : '.ucwords(strtolower($this->tank_auth->get_username())).', '.lang('tanggal_jam').' : '.date('d/m/Y H:i:s')?> <br />
                </td>
              </tr> 
          </table>
