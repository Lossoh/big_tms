...
<a href="<?=base_url()?>clients/files/add/<?=$this->uri->segment(4)*1200?>" data-toggle="ajaxModal" title="<?=lang('upload_file')?>" class="btn btn-sm green pull-right"><?=lang('upload_file')?></a> 
 </header>
...
<a href="<?=base_url()?>clients/files/delete/<?=$f->file_id*1800?>/<?=$f->project*1200?>" data-toggle="ajaxModal" class="btn red btn-xs active">
