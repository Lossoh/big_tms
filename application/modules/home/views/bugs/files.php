...
<a href="<?=base_url()?>clients/bug_files/add/<?=$this->uri->segment(4)*1200?>"  data-toggle="ajaxModal" title="<?=lang('attach_file')?>" class="btn btn-sm green pull-right"><?=lang('upload_file')?></a> 
 </header>
...
<a href="<?=base_url()?>clients/bug_files/delete/<?=$f->file_id*1800?>/<?=$f->bug*1200?>" title="<?=lang('delete_file')?>" data-toggle="ajaxModal" class="btn red btn-xs active">
