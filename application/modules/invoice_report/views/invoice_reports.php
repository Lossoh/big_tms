...
<section class="vbox">
    <header class="header bg-white b-b b-light">
        ...
        <p class="pull-left"><?=lang('invoice_report')?> Report</p>
    </header>
        ...
        <div class="col-lg-12">
          <div class="panel panel-primary">
            <div class="panel-body">
                <?=form_open(base_url('invoice_report/print_report'),'autocomplete="off" id="form" name="form" class="form-horizontal" target="_blank"')?>
                    ...
                    <div class="col-md-3">
                        <select class="form-control all_select2" name="debtor_id" id="debtor_id">
                            ...
                            foreach($debtors as $debtor){
                                echo '<option value="'.$debtor->rowID.'">'.$debtor->debtor_name.'</option>'; 
                            }
                            ?>
                        </select>
                    </div>
