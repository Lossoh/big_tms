...
<section class="vbox">
    <header class="header bg-white b-b b-light">
        ...
        <p class="pull-left"><?=lang('loan_report')?></p>
    </header>
        ...
        <div class="col-lg-12">
          <div class="panel panel-primary">
            <div class="panel-body">
                <?=form_open(base_url('loan_report/print_report'),'autocomplete="off" id="form" name="form" class="form-horizontal" target="_blank"')?>
                ...
                <div class="form-group form-md-line-input row">
                    <label class="col-md-3 control-label">Debitor Name<span class="text-danger">*</span></label>
                    <div class="col-md-3">
                        <select class="form-control all_select2" name="debtor_id" id="debtor_id">
                            <option value="all">All</option>
                            <?php
                            foreach($debtors as $debtor){
                                echo '<option value="'.$debtor->rowID.'">'.$debtor->type.$debtor->debtor_cd.' - '.$debtor->debtor_name.'</option>'; 
                            }
                            ?>
                        </select>
                    </div>
                ...
                <div class="form-group form-md-line-input row">
                    <label class="col-md-3 control-label">Balance Status<span class="text-danger">*</span></label>
                    <div class="col-md-2">
