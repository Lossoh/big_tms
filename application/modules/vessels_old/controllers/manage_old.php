...
class Manage extends MX_Controller {
	...
	function add_unload_receipt()
	{
		if ($this->input->post()) {
			...
			$Data  = $initialized;
			$Data .= $condensed1;
			$Data .= "\t\t\t".$font1.$bold1."SURAT MUAT".$bold0.$font0."\n";
			$Data .= "-------------------------------------\n\n";
			$Data .= "Ref".chr(9).": ".$font1.$bold1.$ur_detail->vessel_ref.$bold0.$font0."\n\n";
			$Data .= "Vessel".chr(9).": ".$font1.$bold1.$ur_detail->vessel_name.$bold0.$font0."\n\n";
			$Data .= "No Reg".chr(9).": ".$font1.$bold1.$ur_detail->unload_receipt_ref.$bold0.$font0."\n\n";
			$Data .= "Truck No: ".$font1.$bold1.$ur_detail->truck_name.$bold0.$font0."\n\n";
			$Data .= "Trans".chr(9).": ".$font1.$bold1.$ur_detail->transporter_name.$bold0.$font0."\n\n";
			$Data .= "Driver\t: ".$font0.$ur_detail->driver_name."\n\n";
			$Data .= "Remark\t: ".$font0.$ur_detail->description."\n\n";
			$Data .= "Expired\t: ".strftime("%d %b %Y", strtotime($ur_detail->expired_date))."\n\n";
			$Data .= "PALKA\t:\n\n";
			$Data .= "PETUGAS\t".$font0.$ur_detail->username."\t..................\n\n\n";
			$Data .= "PETUGAS KADE\t".$font0.$ur_detail->username."\t............\n\n\n";
			$Data .= "PETUGAS PBM\t".$font0.$ur_detail->username."\t............\n\n\n";
			$Data .= "PETUGAS LAIN\t".$font0.$ur_detail->username."\t............";
			fwrite($handle, $Data);
			fclose($handle);
