...
<div class="modal-dialog" id="add_modal">
	<div class="modal-content">
		...
		<div class="modal-header"> <button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title"><?=lang('delete_unload_receipt')?></h4>
		</div>
					
		<?php 

		$attributes = array('class' => 'bs-example form-horizontal');
        echo form_open(base_url().'vessels/manage/delete_unload_receipt',$attributes); ?>          
		...
		<div class="modal-body">
			...
			<label class="col-lg-4 control-label"><?=lang('description')?></label>
				<div class="col-lg-8">
					<textarea name="description" class="form-control" maxlength="255" rows="8" disabled><?=$unload_receipt_detail->description?></textarea>
				</div>
			</div>				
		</div>
		<div class="modal-footer"><a href="#" class="btn btn-default" data-dismiss="modal"><?=lang('close')?></a> 
		<button type="submit" class="btn green"><?=lang('delete_unload_receipt')?></button>
		</form>
<?php }}?>
		</div>
	</div>
