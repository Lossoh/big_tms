				...
				<div class="modal-body">
					...
					<input type="hidden" class="form-control" value="<?=$destination_detail->document_separate_id?>" name="document_separate_id">
						...
						<div class="col-lg-8">
							...
							<input type="text" class="form-control" value="<?=$destination_detail->destination_id?>" name="destination_id">
							<input type="text" class="form-control" value="<?=$destination_detail->destination_name?>" name="destination_name">
					...
					<div class="col-lg-8">
						<textarea name="destination_description" class="form-control"  required readonly><?=$destination_detail->destination_description?></textarea>
					</div>
					</div>	
					...
					<div class="col-lg-8">
						<textarea name="remarks" class="form-control" required readonly><?=$destination_detail->remarks?></textarea>
					</div>
					</div>					
