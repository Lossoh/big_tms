        ...
        <header class="header bg-white b-b b-light">
            <div class="row" style="padding-top: 10px;">
                <div class="col-md-6" style="padding-top: 5px;">
                    <p><?=lang('account_payable_details')?></p>              
                </div>     
                <div class="col-md-6 text-right">
                    ...
                    ?>
                        <a  class="btn btn-sm green" onclick="add_ap()"><i class="fa fa-plus"></i> <?=lang('new')?> <?=lang('account_payables')?></a>
                    <?php
                    }
                    ?>
                </div>
  ...
  <div class="modal-dialog" style="width:1200px;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title">Add Account Payable (AP)</h3>
      </div>
            ...
            <div class="row">  
                <div class="col-xs-6">
					<div class="group">	
						<div class="row inline-fields form-group form-md-line-input">
							<div class="col-md-4">AP Date<span class="text-danger">*</span></div>
							<div class="col-md-1">:</div>
							<div class="col-md-6"><p>
								<input type="text" class="form-control tanggal_datetimepicker" name="ap_date" id="ap_date" onblur="setComeBack()" value="<?=date('d-m-Y')?>" required="" />
                        ...
                        <div class="row inline-fields form-group form-md-line-input">
							...
							<div class="col-md-1">:</div>
							<div class="col-md-6"><p>
								<input type="text" class="form-control tanggal_datetimepicker"  name="come_back" id="come_back" value="<?=date('d-m-Y', strtotime("+30 days"));?>" required="" />
							</p></div>								
						</div>
                        <div class="row inline-fields form-group form-md-line-input">
                        ...
                        <div class="row inline-fields form-group form-md-line-input">
							<div class="col-md-4">AP Type<span class="text-danger">*</span></div>
							<div class="col-md-1">:</div>
							<div class="col-md-6"><p>
                ...
                <div class="col-xs-6">
					<div class="group">	
                       ...
                       <div class="row inline-fields form-group form-md-line-input">
							<div class="col-md-4">Total<span class="text-danger">*</span></div>
							<div class="col-md-1">:</div>
							<div class="col-md-6"><p>										
                       ...
                       <div class="row inline-fields form-group form-md-line-input">
							<div class="col-md-4">Base Total<span class="text-danger">*</span></div>
							<div class="col-md-1">:</div>
							<div class="col-md-6"><p>										
                       ...
                       <div class="row inline-fields form-group form-md-line-input">
							<div class="col-md-4">PPN 10%<span class="text-danger">*</span></div>
							<div class="col-md-1">:</div>
							<div class="col-md-6"><p>										
                                <input type="text" class="form-control" id="tax_amt" name="tax_amt" value="0" readonly="" style="text-align: right;" required="" />
							</p></div>
					   </div>
                       <div class="row inline-fields form-group form-md-line-input general_type">
							<div class="col-md-4">Total AP JO<span class="text-danger">*</span></div>
							<div class="col-md-1">:</div>
							<div class="col-md-6"><p>										
                       ...
                       <div class="row inline-fields form-group form-md-line-input">
							...
							<div class="col-md-1"></div>
							<div class="col-md-6"><p>										
                                <input type="checkbox" name="cekDa" id="cekDa" value="1" onclick="taxTrue()" /> &nbsp;Without Tax
							</p></div>
						</div>
...
<aside class="aside-xxl bg-white b-l hide" id="aside">
    <section class="vbox">
		<section class="scrollable wrapper">
            <?=form_open(base_url().'account_payable/set_filter','autocomplete="off" id="form_period" class="form-horizontal"')?>                    
            <div class="row">
                <div class="col-md-9">
...
$(function() {
        ...
        var table_account_payable = $('#tbl-account-payable').DataTable({
            processing: true,
            serverSide: true,
            sDom: "<'row'<'col-sm-6'l><'col-sm-6'f>r>t<'row'<'col-sm-6'i><'col-sm-6'p>>",
            sPaginationType: "full_numbers",
            ajax: {
                url: "<?= base_url() ?>account_payable/fetch_data",
                type: 'POST',
        ...
        $('.dataTables_filter input').unbind().keyup(function() {
            var value = $(this).val();
            if (value.length > 2) {
                table_account_payable.search(value).draw();
            } 
            if (value.length == 0) {
                table_account_payable.search(value).draw();
            } 
        ...
        $(".start_date").on("dp.change", function (e) {
            ...
            table_account_payable.columns(8).search(start_date).draw();
            $("#start_date").blur();
        });
        $(".end_date").on("dp.change", function (e) {
            var end_date = $("#end_date").val();
            table_account_payable.columns(9).search(end_date).draw();
            $("#end_date").blur();
        });
    });
</script>