<table class="table table-responsive table-striped table-condensed" width="100%">
    <thead>
		...
		<th style="text-align: center;width: 10%;">DO No</th>
    ...
    <tbody>
        ...
        ?>
        		<tr id="baris_<?=$i?>">								
        			<td align="center">
                        <button class="btn btn-sm red" id="delete_do_<?=$i?>" title="Delete" onclick="delete_do('baris_<?=$i?>')"><i class="fa fa-times"></i></button>
