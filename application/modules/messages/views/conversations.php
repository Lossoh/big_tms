								...
								<div class="panel-body">
									...
									<section class="comment-list block">
										...
										<section class="comment-body panel panel-default">
											...
											<a href="<?=base_url()?>messages/conversation/delete/<?=$msg->msg_id*1200?>/<?=$this->uri->segment(4)?>" data-toggle="ajaxModal" class="btn red btn-xs active"><i class="fa fa-trash-o text-white text-active"></i>
											</a>
											<?php } ?></span>
										</header>
