...
<section class="vbox">
    <header class="header bg-white b-b b-light">
        ...
        <p class="pull-left"><?=lang('trial_balance_report')?></p>
    </header>
        ...
        <div class="col-lg-12">
          <div class="panel panel-primary">
            <div class="panel-body">
                <?=form_open(base_url('trial_balance_report/print_report'),'autocomplete="off" id="form" name="form" class="form-horizontal" target="_blank"')?>
                ...
                <div class="form-group form-md-line-input row" id="period_month_year_profit" style="display: none;">
                    ...
                    <div class="col-md-3">
                        <div class="input-group input-daterange">
                            <input type="text" name="start_date" id="start_month" class="form-control input-sm" placeholder="<?=lang('start_date')?>" value="<?=date('01-Y')?>">
