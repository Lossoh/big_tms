        ...
        <td width="36%" valign="top">
            ...
            <table>
                <tr>
                    ...
                    <td>:</td>
                    <td><?=$get_data->trx_no?> [<?=$get_data->tax == 0 ? 'TAX' : strtoupper($this->config->item('comp_cd'))?>]</td>
                </tr>
                <tr>
    ...
    if(!empty($get_data_detail)){
        ...
        $grand_total = $get_data->total_amt;
           ...
           if($i == 1){
                ...
                $no = 1;
                if($jumlah_20ft > 0){
                    $description .= $no.'. 1 x 20 Feet @ '.number_format($jumlah_20ft,2,',','.').' x '.number_format($biaya_20ft,2,',','.').' = '.number_format($jumlah_20ft*$biaya_20ft,2,',','.').'<br>';
                    $no++;
                }
                if($jumlah_40ft > 0){
                    $description .= $no.'. 1 x 40 Feet @ '.number_format($jumlah_40ft,2,',','.').' x '.number_format($biaya_40ft,2,',','.').' = '.number_format($jumlah_40ft*$biaya_40ft,2,',','.').'<br>';
                    $no++;
                }
                if($jumlah_45ft > 0){
                    $description .= $no.'. 1 x 45 Feet @ '.number_format($jumlah_45ft,2,',','.').' x '.number_format($biaya_45ft,2,',','.').' = '.number_format($jumlah_45ft*$biaya_45ft,2,',','.').'<br>';
                    $no++;
                }
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
	<tr>
        ...
        <!--
            ...
            <b>BANK MAYBANK KCP PURI KENCANA</b><br />
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
	<tr>
        ...
        if($get_data->invoice_type == 'A'){
            ...
            echo '<th width="21%" style="border:#000 solid 1px;">DO No</th>';
