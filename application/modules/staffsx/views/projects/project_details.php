														...
														<section class="comment-body panel panel-default">
															...
															<div class="panel-body">
																...
																<div class="comment-action m-t-sm">
																	...
																	<?php
																	if ($comment->posted_by == $this->tank_auth->get_user_id()) { ?>
																	<a href="<?=base_url()?>clients/projects/delcomment?c=<?=$comment->comment_id?>&p=<?=$project->project_id?>" data-toggle="ajaxModal" title="<?=lang('delete')?>"  class="btn red btn-xs"> <i class="fa fa-trash-o text-white"></i> </a>
																	<?php } ?>
																</div>
															</div>
