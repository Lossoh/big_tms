...
<div id="content">
    ...
    ?>
            ...
            <table width="100%" cellpadding="1" cellspacing="0">
                ...
                ?>
                    <tr>
                        <td colspan="5" align="right" style="border-bottom: #000000 solid 5px;border-top: #000000 solid 1px;border-left: #000000 solid 1px;">Total (Rp) &nbsp; </td>
                        <td align="right" style="border-bottom: #000000 solid 5px;border-top: #000000 solid 1px;border-left: #000000 solid 1px;"><?=number_format($total_debit_tunai)?></td>
                        <td align="right" style="border-bottom: #000000 solid 5px;border-top: #000000 solid 1px;"><?=number_format($total_debit_cg)?></td>
                        <td align="right" style="border-bottom: #000000 solid 5px;border-top: #000000 solid 1px;border-left: #000000 solid 1px;"><?=number_format($total_kredit_tunai)?></td>
