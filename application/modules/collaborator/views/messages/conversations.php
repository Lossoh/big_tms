	...
	<section class="hbox stretch">
		...
		<aside class="aside-md bg-white b-r" id="subNav">
			...
			<aside class="bg-light lter b-l" id="email-list">
				...
				<a href="<?=base_url()?>collaborator/conversation/delete/<?=$msg->msg_id*1200?>/<?=$this->uri->segment(4)?>" data-toggle="ajaxModal" class="btn red btn-xs active"><i class="fa fa-trash-o text-white text-active"></i> 
				</a>
									<?php } ?></span>
									</header>
