<section id="content">
	<section class="vbox">
		...
		<header class="header bg-white b-b b-light">
			...
			<?php
			if ($project->timer == 'On') { ?>
			<a href="<?=base_url()?>collaborator/projects/tracking/off/<?=$project->project_id?>" class="btn btn-sm red "> <i class="fa fa-clock-o text-white"></i> <?=lang('stop_timer')?></a>
			<?php }else{ ?>
			...
			<a href="<?=base_url()?>collaborator/projects/pilot/on/<?=$project->project_id*8600?>" data-original-title="<?=lang('auto_progress_on')?>" class="btn btn-sm green" data-toggle="tooltip" data-placement="left"> <i class="fa fa-rocket text-white"></i></a>
			<?php }else{ ?>
			<a href="<?=base_url()?>collaborator/projects/pilot/off/<?=$project->project_id*8600?>"  data-original-title="<?=lang('auto_progress_off')?>" class="btn btn-sm green" data-toggle="tooltip" data-placement="left"> <i class="fa fa-power-off text-white"></i></a>
			<?php } ?>
			</p>
		</header>
															...
															<section class="comment-body panel panel-default">
																...
																<div class="panel-body">
																	...
																	<div class="comment-action m-t-sm">
																		...
																		<?php
																		if ($comment->posted_by == $this->tank_auth->get_user_id()) { ?>
																		<a href="<?=base_url()?>collaborator/projects/delcomment?c=<?=$comment->comment_id?>&p=<?=$project->project_id?>" data-toggle="ajaxModal" title="<?=lang('delete')?>"  class="btn red btn-xs"> <i class="fa fa-trash-o text-white"></i> </a>
																		<?php } ?>
																	</div>
																</div>
