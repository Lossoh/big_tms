...
<a href="<?=base_url()?>collaborator/bug_files/add/<?=$this->uri->segment(4)*1200?>"  data-toggle="ajaxModal" title="<?=lang('attach_file')?>" class="btn btn-sm green pull-right"><?=lang('upload_file')?></a> 
 </header>
