...
<title><?=lang('do_not_yet_invoiced_report')?> Report</title>
</head>
...
<br />
<div id="header">
    <span style="font-size: 16px;"><?=strtoupper(lang('do_not_yet_invoiced_report').' Report')?></span><br />
...
<table width="100%" cellpadding="3" cellspacing="0">
	<tr>
        ...
        <th style="border: #000000 solid 1px;" width="9%">Tonase Receive</th>
    </tr>  
	<?php 
    $i=0;
