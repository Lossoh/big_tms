...
<section class="vbox">
    <header class="header bg-white b-b b-light">
        ...
        <p class="pull-left"><?=lang('do_not_yet_invoiced_report')?> Report</p>
    </header>
        ...
        <div class="col-lg-12">
          <div class="panel panel-primary">
            <div class="panel-body">
                <?=form_open(base_url('do_not_yet_invoiced_report/print_report'),'autocomplete="off" id="form" name="form" class="form-horizontal" target="_blank"')?>
