                    ...
                    <div class="tab-content">
                        ...
                        <div id="do_process" class="tab-pane">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2" style="padding: 0px 10px 0px 0px">
									<input type="text" class="form-control input-sm" id="do_officer_name" name="do_officer_name" maxlength="30" autocomplete="off" value="<?=$document_detail->do_officer_name?>" />
                                </div>
                            </div>
                            <br />
                            <div class="row">
                                ...
                                <div class="col-md-2" style="padding: 0px 10px 0px 0px">
									<input type="text" class="form-control input-sm tanggal_datetimepicker" id="redeem_date" name="redeem_date" autocomplete="off" value="<?=$document_detail->redeem_date == '1970-01-01' || $document_detail->redeem_date == '' ? date('d-m-Y') : date('d-m-Y',strtotime($document_detail->redeem_date))?>" />
                                </div>
                            </div>
                            <br />
                            <div class="row">
                                ...
                                <div class="col-md-2" style="padding: 0px 10px 0px 0px">
									<input type="text" class="form-control input-sm tanggal_datetimepicker" id="validation_date" name="validation_date" autocomplete="off" value="<?=$document_detail->validation_date == '1970-01-01' || $document_detail->validation_date == '' ? date('d-m-Y') : date('d-m-Y',strtotime($document_detail->validation_date))?>" />
                                </div>
                            </div>
                            <br />
                            <div class="row">
                                ...
                                <div class="col-md-2" style="padding: 0px 10px 0px 0px">
									<input type="text" class="form-control input-sm tanggal_datetimepicker" id="validation_date_1" name="validation_date_1" autocomplete="off" value="<?=$document_detail->validation_date_1 == '1970-01-01' || $document_detail->validation_date_1 == '' ? date('d-m-Y') : date('d-m-Y',strtotime($document_detail->validation_date_1))?>" />
                                </div>
                            </div>
                            <br />
                            <div class="row">
                                ...
                                <div class="col-md-2" style="padding: 0px 10px 0px 0px">
									<input type="text" class="form-control input-sm tanggal_datetimepicker" id="validation_date_2" name="validation_date_2" autocomplete="off" value="<?=$document_detail->validation_date_2 == '1970-01-01' || $document_detail->validation_date_2 == '' ? date('d-m-Y') : date('d-m-Y',strtotime($document_detail->validation_date_2))?>" />
                                </div>
                            </div>
                        </div>
