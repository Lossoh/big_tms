						...
						<div class="group">	
							...
							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
								...
								<div class="col-md-6">
									...
									<select class="form-control input-sm" id="job_order_type" name="job_order_type" required>	
							...
							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
								...
								<div class="col-md-1">:</div>
								<div class="col-md-6">
									<input  type="text" class="form-control input-sm" id="po_spk_no" name="po_spk_no" maxlength="30" value="<?=$job_order['po_spk_no']?>" autocomplete="off" required>
								</div>
							</div>
							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
								...
								<div class="col-md-1">:</div>
								<div class="col-md-6">
									<input  type="text" class="form-control input-sm" id="so_no" name="so_no" maxlength="30" value="<?=$job_order['so_no']?>" autocomplete="off">
								</div>
							</div>
							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
							...
							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
								...
								<div class="col-md-1">:</div>
								<div class="col-md-5">
									<input  type="text" class="form-control input-sm" id="vessel_no" name="vessel_no" maxlength="15" value="<?=$job_order['vessel_no']?>" autocomplete="off" readonly="" />
								</div>
                                <div class="col-md-1" style="padding-left: 0px;"><button type="button" class="btn btn-sm btn-info" onclick="serach_vessel_jo()"><i class="fa fa-search"></i></button></div>
							</div>								
							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
								<div class="col-md-4"><?=lang('vessel_name')?></div>
								<div class="col-md-1">:</div>
								<div class="col-md-6">
									<input  type="text" class="form-control input-sm" id="vessel_name" name="vessel_name" maxlength="40" value="<?=$job_order['vessel_name']?>" autocomplete="off" readonly="" />
								</div>
							</div>
							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
						...
						<div class="group">
							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
								...
								<div class="col-md-6">								
									...
									<textarea class="form-control input-sm"  id="fare_trip_dtl" name="fare_trip_dtl" maxlength="60" rows="2" readonly><?=$job_order['destination_from_no']?> - <?=$job_order['destination_from_name']?> TO <?=$job_order['destination_to_no']?> - <?=$job_order['destination_to_name']?> Distance : <?=$job_order['distance']?> km</textarea>
							...
							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
 							...
 							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
								...
								<div class="col-md-1">:</div>
								<div class="col-md-5">
									<input  type="text" class="form-control input-sm" id="job_order_price" name="job_order_price" onkeyup="IsNumeric(this)" placeholder="Ex : 50,5" maxlength="9" value="<?=$job_order['price_amount']?>" style="text-align: right;" autocomplete="off">
								</div>
								<div class="col-md-1" style="padding-left: 0px;"><big>Kgs</big></div>								
							</div>
							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
								...
								<div class="col-md-1">:</div>
								<div class="col-md-6">
									<textarea class="form-control input-sm"  id="job_order_desc" name="job_order_desc" maxlength="50" rows="2"><?=$job_order['description']?></textarea>									
								</div>
							</div>
							<div class="line"></div>
							<div class="row inline-fields form-group form-md-line-input" style="padding-bottom: 10px;">
    ...
    $.ajax({
        ...
        success: function(result){
            ...
            $.each(result, function(key, data) {	
				isi_table += '<tr onclick="get_data_vessel(\''+data.trx_no+'\',\''+data.vessel_name+'\')" style="cursor:pointer">'+
                                '<td>'+no+'</td>' +
                                '<td>'+data.trx_no+'</td>' +
        						'<td>'+data.eta_date+'</td>' +
