            ...
            <div class="row" style="padding-top: 10px;">
                ...
                <div class="col-md-6 text-right">
                   <!--  <a href="#aside" data-toggle="class:show" id="btnFilter" onclick="showFilterText()" style="color: #46b8da;">Show Filter</a> &nbsp; -->
                    ...
                    ?>
                        <a href="<?php echo base_url().'job_order_emkl/create_job_order_emkl'; ?>"  class="btn btn-sm green"><i class="fa fa-plus"></i> <?=lang('new_job_order_emkl')?></a>
                    <?php
                    }
                    ?>
                </div>
...
<aside class="aside-xxl bg-white b-l hide" id="aside">
    <section class="vbox">
		<section class="scrollable wrapper">
            <?=form_open(base_url().'job_order_emkl/set_filter','autocomplete="off" id="form_period" class="form-horizontal"')?>                    
            <div class="row">
                <div class="col-md-9">
...
$(function() {
        ...
        var table_job_order = $('#tbl-job-order').DataTable({
            ...
            ajax: {
                url: "<?= base_url() ?>job_order_emkl/fetch_data",
                type: 'POST',
        ...
        $(".start_date").on("dp.change", function (e) {
            ...
            table_job_order.columns(10).search(start_date).draw();
            $("#start_date").blur();
        });
        $(".end_date").on("dp.change", function (e) {
            var end_date = $("#end_date").val();
            table_job_order.columns(11).search(end_date).draw();
            $("#end_date").blur();
        });
    });
</script>