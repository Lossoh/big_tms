				...
				<header class="header bg-white b-b clearfix hidden-print">
					<div class="row m-t-sm">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?=base_url()?>orders/manage/delivery_order_list/<?=$this->uri->segment(4)?>"><?=lang('sjk_list')?></a></li>
						</ul>
						</div>	
						<div class="btn-group">
							  ...
							  <tbody>
								  ...
								  <tr>									
									...
									<td>
										...
										<a href="<?=base_url()?>orders/manage/deletebarcode/<?=$sjk_order_list->sj_id?>" class="btn btn-default btn-xs" data-toggle="ajaxModal" title="<?=lang('delete')?>"><i class="fa fa-trash-o fa-lg"></i></a>									
