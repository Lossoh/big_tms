			...
			<section class="vbox">
				...
				<section class="scrollable wrapper w-f">
					...
					<?php     
						...
						echo form_open(base_url().'orders/addbarcode', $attributes); ?>
						<div class="row"> 
							...
							<div class="col-xs-6">
								<div class="group">
									...
									<div class="col-md-4"><?=lang('barcode_id')?></div>
									<div class="col-md-1">:</div>
									<div class="col-md-7"><input style="height:30px" type="text" name="barcode_id_add" id="barcode_id_add" placeholder="Input Barcode ID" class="form-control" autocomplete="off" autofocus></div>
									</div>
					...
					<div><button type="submit" class="btn btn-sm btn-success"><i class="fa fa-check"></i> <?=lang('save')?></button><input class="btn btn-sm yellow" type="button" onclick="window.location.replace('<?=base_url()?>orders/barcode_lists')" value="Back To Barcode List" /> </div>
							</form>
					<div></div>
					</section> 
