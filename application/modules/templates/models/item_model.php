...
class Item_model extends CI_Model
{
	...
	function list_tasks($limit)
	{
		return $this->db->order_by('added','desc')->get('saved_tasks',$limit,$this->uri->segment(3))->result();
	}
	...
	function search_task($keyword,$limit)
	{
		return $this->db->like('task_desc', $keyword)->order_by("added","desc")->get('saved_tasks',$limit,$this->uri->segment(3))->result();
	}
